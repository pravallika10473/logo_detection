...
#SBATCH --mem=32G
#SBATCH --gres=gpu:1
#SBATCH --output=/scratch/general/vast/u1475870/logo_detection/logs/%j/%j_iou.out
#SBATCH --error=/scratch/general/vast/u1475870/logo_detection/logs/%j/%j_iou.err
...
cp -f /uufs/chpc.utah.edu/common/home/$USER/logo_detection/iou.py .
...
if [ $? -eq 0 ]; then
    ...
    # Copy results back
    OUTPUT_DIR="/uufs/chpc.utah.edu/common/home/$USER/logo_detection/outputs/iou_results"
    mkdir -p $OUTPUT_DIR
